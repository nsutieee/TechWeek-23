    ...
    <footer>
      <div className="row" id="footer" style={{paddingLeft:"30px"}}>
        <div className="col">
          ...
          <div>
          TechWeek is the annual flagship event of IEEE NSUT comprising various tech events, networking, speaker sessions, workshops, tech competitions, mind-boggling group discussions, and the largest hackathon in North India, HackNSUT. We’re unifying it into a single cross-disciplinary offline experience so that some unique knowledgeable insights could be given to students attending it from various zones of India with diverse domains and skills. It’s not only limited to tech activities, the integration of fun sessions and networking opportunities at the end of the day makes it unique in itself because that networking opportunity would lead to the formation of some great teams in the post-event scenario.
        ...
        <div className="col">
          ...
          ></div> */}
         <a href="https://discord.gg/PtmKS5ke" target={"_blank"} className="discord_wrap">
